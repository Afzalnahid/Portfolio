            ...
            >
              ...
              <div className="p-5 border-b border-white/5 flex items-center justify-between bg-slate-900 z-10 relative">
                ...
                <div className="flex items-center gap-3">
                  <a 
                    href="https://calendar.google.com/calendar/u/0?cid=bmFoaWRhZnphbDk3QGdtYWlsLmNvbQ" 
                    target="_blank" 
              ...
              <div className="flex-grow w-full bg-white relative">
                ...
                <iframe
                  src="https://calendar.google.com/calendar/u/0?cid=bmFoaWRhZnphbDk3QGdtYWlsLmNvbQ"
                  style={{ border: 0 }}
                  width="100%"
                  height="100%"
                  frameBorder="0"
