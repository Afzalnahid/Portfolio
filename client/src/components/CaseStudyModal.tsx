...
import { X, Target, Lightbulb, TrendingUp, CheckCircle2 } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div className="p-8 border-t border-white/5 bg-white/5 flex justify-end">
              <button className="px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-600/20">
