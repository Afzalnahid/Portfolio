const projects = [
  {
    ...
    description:
      "AI-powered jewelry chatbot with image recognition and multi-language support.",
    tags: ["n8n", "AI", "E-Commerce"],
    icon: "💎",
    color: "from-blue-600/20 to-transparent",
  },
  {
    title: "Viral Talking Food Generator",
    description:
      "Automated system for generating engaging food content with AI narration.",
  ...
  },
  {
    ...
    description:
      "Product matching system using computer vision and machine learning.",
  ...
  },
  {
    ...
    description:
      "Unified chatbot solution across Facebook Messenger, WhatsApp, and Telegram.",
  ...
  },
  {
    ...
    description:
      "Custom automation workflows for various business processes and integrations.",
